  ...
  return (
    <div className={styles.process__layout}>
      <div className={styles.process__aside}>
        <div className={styles.process__header} data-component="aside-header">
          <SectionLabel label="Process" animationData={Box} />
...
const Process: React.FC = () => {
  ...
  return (
    <section id="process" className={styles.process} ref={processRef}>
